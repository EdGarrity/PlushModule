...
namespace Plush
{
 ...
 //                   explicit CodeAtom(const ExecAtom& other) : Atom(other.instruction_name, other.close_parenthesis, other.type) {};
 //                   explicit CodeAtom(const Atom& other) : Atom(other.instruction_name, other.close_parenthesis, other.type) {}; // New constructor
