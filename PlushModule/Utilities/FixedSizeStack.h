	...
	public:
		...
		inline void set_top(unsigned long new_top)
		{
			if (new_top >= N)
			{
				...
				error_message << "Utilities::FixedSizeStack::set_top() - Stack overflow.  new_top = ";
				error_message << new_top;
		...
		inline const_reference operator [] (unsigned long index) const
		{
			if (index >= N)
			{
				...
				error_message << "const_reference Utilities::FixedSizeStack::operator [] - Index Out Of Range.  index = ";
				error_message << index;
		...
		inline reference operator [] (unsigned long index)
		{
			if (index >= N)
			{
				...
				error_message << "reference Utilities::FixedSizeStack::operator [] - Index Out Of Range.  index = ";
				error_message << index;
		...
		inline const_reference get_atom_at_index(size_t index) const
		{
			if (index >= N)
			{
				...
				error_message << "const_reference Utilities::FixedSizeStack::get_atom_at_index - Index Out Of Range.  index = ";
				error_message << index;
		...
		inline reference get_atom_at_index(size_t index)
		{
			if (index >= N)
			{
				...
				error_message << "reference Utilities::FixedSizeStack::get_atom_at_index - Index Out Of Range.  index = ";
				error_message << index;
		...
		inline reference get_atom_at_index_unmanaged(size_t index)
		{
			if (index >= N)
			{
				...
				error_message << "reference Utilities::FixedSizeStack::get_atom_at_index_unmanaged - Index Out Of Range.  index = ";
				error_message << index;
		...
		inline unsigned long replace(T& other, unsigned long n)
		{
			if (n >= N)
			{
				...
				error_message << "reference Utilities::FixedSizeStack::replace() - Stack overflow.  index = ";
				error_message << n;
		...
		inline unsigned long replace_section(unsigned long source_position, unsigned long target_position, unsigned long length)
		{
			if ((source_position >= N) || (source_position >= top_))
			{
				...
				error_message << "reference Utilities::FixedSizeStack::replace_section() - Stack overflow.  source_position = ";
				error_message << source_position;
			...
			if ((target_position >= N) || (target_position >= top_))
			{
				...
				error_message << "reference Utilities::FixedSizeStack::replace_section() - Stack overflow.  target_position = ";
				error_message << target_position;
